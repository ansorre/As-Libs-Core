...
package me.as.lib.core.io.util;
...
public class FileSystemRoom
{
 ...
 public synchronized void deleteTree(String dname)
 {
  try
  {
   ...
   do
   {
    files=removeNullAndEmpty(files);
 ...
 public static void main(String args[])
 {
  ...
  {
   String tfn=FileSystemUtil.getTemporaryFileName();
  ...
  System.out.println("\n");StringUtil.systemOut(fsr.listAll("/", "*"));
  System.out.println("\n");StringUtil.systemOut(fsr.listAll("/", "s*"));
  System.out.println("\n");StringUtil.systemOut(fsr.listAll("/", "????????????")); // must return empty array
  System.out.println("\n");StringUtil.systemOut(fsr.listAll("/"));
  System.out.println("\n");StringUtil.systemOut(fsr.listAll(""));  // must return null array (because of bad file name)

  System.out.println("\n");StringUtil.systemOut(fsr.listDirs("/"));
  System.out.println("\n");StringUtil.systemOut(fsr.listDirs("/", "o*"));
  System.out.println("\n");StringUtil.systemOut(fsr.listFiles("/"));
  System.out.println("\n");StringUtil.systemOut(fsr.listFiles("/", "*s*"));


  System.out.println("\n");StringUtil.systemOut(fsr.listTheTree("/"));
  System.out.println("\n");StringUtil.systemOut(fsr.listTheTree("/fullDir"));


  //System.out.println("\n");StringUtil.systemOut(FileSystemUtil.listTheTree("C:\\tmp"));
 }
