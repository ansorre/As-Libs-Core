...
import static me.as.lib.core.lang.RandomExtras.compositeRandom;
...
//  FileBytesRoom fbr=new FileBytesRoom(tfn, false);
  ...
  for (t=0;t<llen;t++)
  {
   ...
   /*
   s=StringUtil.newString(pbr.getPiece((long)MathUtil.random(len)));
   System.out.println("read:\n"+s+"\n");

   if (StringUtil.select(ts, s)>=0) System.out.println("--------> SUCCESS!");
