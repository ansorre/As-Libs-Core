...
public class RandomExtras
{
 ...
 {
//  return new CellularAutomatonRNG(BytesUtil.intToBytes((new Random()).nextInt()));
  return new Random();
 }
 ...
 */
 ...
 public static void main(String args[])
 {
  ...
  int t, len=100;
  for (t=0;t<len;t++) counts[ObjectUtil.select(objs, randomSelect(objs))]++;
...
for (t=0;t<len;t++)
{
System.out.println(StringUtil.formatDouble(gaussianRandom(-2.5, 2.5), 5, 5, Pasquale.ITALIAN));
}
}            */
 ...
 /* TEST: SUCCESS
  ...
  public static void main(String args[])
  {
   ...
   for (t=0;t<len;t++)
   {
    System.out.println(StringUtil.formatDouble(gcr[t], Pasquale.ITALIAN));
   }
  }
 ...
 */
 ...
 /*
  ...
  public static void main(String args[])
  {
   ...
   for (t=0;t<len;t++)
   {
    System.out.println(MathUtil.compositeRandom(100, 10, 10));
   }
  }
 */
